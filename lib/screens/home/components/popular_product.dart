...
class _PopularProductsState extends State<PopularProducts> {
    ...
    return Column(
      children: [
        Padding(
          ...
          child: SectionTitle(title: "Ikan Terpopuler", press: () {}),
        ),
                ...
                child: Row(
                  children: [
                    ...List.generate(
                      ...
                      (index) {
                        return ProductCard(product: snapshot.data[index], prefixHero: "pop",);
                      },
                    ),
  ...
  Future<List<Product>> _getListProduct() async {
    ...
    final response = await http.get(Uri.parse('${ENDPOINTAPI}/api/product/popular'),headers: reqHeaders);
